...
const translations: Record<Lang, Record<string, string>> = {
  pt: {
    ...
    "plans.instant.try": "Testar grátis antes de assinar",
    "plans.instant.how": "Automático (IA)",
    "plans.artisan.how": "Artesanal",
    "plans.feature.modelagem": "Como é feito",
    "plans.feature.bim": "Blocos nativos SKP / Revit / Archicad",
    "plans.feature.revisao": "Revisão humana garantida",
    ...
    "plans.instant.f1": "30 produtos gerados automaticamente por mês",
    "plans.instant.f2": "Modelo 3D no navegador e em realidade aumentada",
    "plans.instant.f3": "Nota de fidelidade em cada produto",
    "plans.instant.f4": "Download dos arquivos GLB e USDZ",
    "plans.instant.f5": "Embed do visualizador no seu site",
    "plans.instant.f6": "Sem blocos BIM nativos — veja Starter",
  ...
  en: {
    ...
    "plans.instant.try": "Try free before subscribing",
    "plans.instant.how": "Automatic (AI)",
    "plans.artisan.how": "Handcrafted",
    "plans.feature.modelagem": "How it is made",
    "plans.feature.bim": "Native SKP / Revit / Archicad blocks",
    "plans.feature.revisao": "Guaranteed human review",
    ...
    "plans.feature.invoice": "NF-e / Invoice",
    "plans.instant.f1": "30 auto-generated products per month",
    "plans.instant.f2": "3D model in browser and augmented reality",
    "plans.instant.f3": "Fidelity score on every product",
    "plans.instant.f4": "GLB and USDZ file downloads",
    "plans.instant.f5": "Viewer embed on your website",
    "plans.instant.f6": "No native BIM blocks — see Starter",
  ...
  es: {
    ...
    "plans.instant.try": "Probar gratis antes de suscribirte",
    "plans.instant.how": "Automático (IA)",
    "plans.artisan.how": "Artesanal",
    "plans.feature.modelagem": "Cómo se hace",
    "plans.feature.bim": "Bloques nativos SKP / Revit / Archicad",
    "plans.feature.revisao": "Revisión humana garantizada",
    ...
    "plans.feature.invoice": "NF-e / Invoice",
    "plans.instant.f1": "30 productos generados automáticamente al mes",
    "plans.instant.f2": "Modelo 3D en el navegador y en realidad aumentada",
    "plans.instant.f3": "Nota de fidelidad en cada producto",
    "plans.instant.f4": "Descarga de archivos GLB y USDZ",
    "plans.instant.f5": "Visor integrado en tu sitio web",
    "plans.instant.f6": "Sin bloques BIM nativos — ver Starter",
