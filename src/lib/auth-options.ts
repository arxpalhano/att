/**
 * Configuração do NextAuth (Microsoft Entra). Fica fora da rota para que
 * outras rotas de API consigam ler a sessão com `getServerSession(authOptions)`
 * — o log de atividades usa isso para carimbar o e-mail da sessão Microsoft.
 */
