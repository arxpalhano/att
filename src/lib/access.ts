...
export const NOT_IN_MATRIX = "Base de Conhecimento é liberada base a base (na própria tela). Atividade só aparece para o dono do portal e para o Lucas Liles. Desempenho da equipe é só do super admin (marcado no cadastro do usuário).";
